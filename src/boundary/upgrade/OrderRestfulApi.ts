...
import CancelOrderController from "../controllers/upgrade/CancelOrderController";
import GetAllOrdersController from "../controllers/upgrade/GetAllOrdersController";
import GetOrderController from "../controllers/upgrade/GetOrderController";
import GetOrderedOrdersController from "../controllers/upgrade/GetOrderedOrdersController";
import GetOrdersByKeyWordController from "../controllers/upgrade/GetOrdersByKeyWordController";
import OptimizedNewOrderController from "../controllers/upgrade/OptimizedNewOrderController";
import RemoveOrderController from "../controllers/upgrade/RemoveOrderController";
import UpdateOrderStatusController from "../controllers/upgrade/UpdateOrderStatusController";
import UpgradedCreateOrderController from "../controllers/upgrade/UpgradedCreateOrderController";
import OrderInfoConverter from "../converters/upgrade/OrderInfoConverter";
...
export default class OrderRestfulApi extends RestfulApi {
    ...
    // Fields:
    private orderInfoConverter: AsyncConverter<Order, OrderInfo>;
